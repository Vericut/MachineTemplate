...
<VcControl Version="7.1" Unit="millimeter">
  ...
  <Subroutines>
    <File>V:\vericut_7.1\FSQ80KR_A2 (TNC430)_v7.1\hei530.sub</File>
  </Subroutines>
  <Words>
    ...
    <Word Name="MULTIPLY" Type="multiplication">
    </Word>
  ...
  <SuperGroup Name="Specials">
    <Group Name="#" Type="word" Description="" Field="0">
      <ConditionMacro>
        ...
        <Variable Name="CGT_DEF7_INDEX" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="CGT_DEF7_WORK_OFFSET"/>
        </Variable>
  ...
  <SuperGroup Name="States">
    ...
    <Group Name="F" Type="word" Description="" Range="99999" Field="0">
      <ConditionMacro>
        <Macro Name="MotionRapid" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="IPA" Type="word" Description="" Field="0">
      <ConditionMacro>
    ...
    <Group Name="M" Type="word" Description="" Range="129" Field="0">
      <ConditionMacro>
        <Macro Name="RotaryControlPointOnOff" Scan="no" AfterMotion="yes">
  ...
  <SuperGroup Name="Loop">
    ...
    <Group Name="END" Type="word" Description="" Field="0">
      <ConditionMacro>
        ...
        <Macro Name="EndSub" Scan="yes" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <Macro Name="Unsupported" Scan="no" AfterMotion="no">
  ...
  <SuperGroup Name="Registers">
    <Group Name="A" Type="word" Description="" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="DEF" Range="7.1 7.2 7.3 7.4 7.5"/>
    ...
    <Group Name="CALL" Type="word" Description="" Range="NONE" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="IX" Type="word" Description="" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="DEF" Range="7.1"/>
      ...
      <ConditionMacro>
        ...
        <Variable Name="5201" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#5201+$"/>
        </Variable>
      </ConditionMacro>
    </Group>
    <Group Name="IY" Type="word" Description="" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="DEF" Range="7.1"/>
      ...
      <ConditionMacro>
        ...
        <Variable Name="5202" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#5202+$"/>
        </Variable>
      </ConditionMacro>
    </Group>
    <Group Name="IZ" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <Variable Name="5203" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#5203+$"/>
        </Variable>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="LBL" Type="word" Description="" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="CALL"/>
        <Macro Name="Heid_CallSubName" Scan="yes" AfterMotion="yes">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
      ...
      <ConditionMacro>
        <Macro Name="Heid_LabelMacro" Scan="yes" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="204" Type="variable" Description="" Field="0">
      <ConditionMacro>
        <Macro Name="CycleRetraction" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$-#200"/>
        </Macro>
      </ConditionMacro>
    </Group>
  ...
  <SuperGroup Name="M_Misc">
    ...
    <Group Name="M" Type="word" Description="" Range="6" Field="0">
      <ConditionMacro>
        ...
        <Macro Name="ToolChangeMachineSubroutine" Scan="no" AfterMotion="yes">
        </Macro>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="DEF" Type="word" Description="" Range="4.0" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="DEF" Type="word" Description="" Range="5.0" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="DEF" Type="word" Description="" Range="7.4" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="#"/>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
    ...
    <Group Name="DEF" Type="word" Description="" Range="7.5" Field="0">
      <ConditionMacro>
        <CondWord Logical="and" Name="#"/>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
    ...
    <Event Type="conversion_init">
      ...
      <EventSub Name="1">
        ...
        <Macro Name="SetDynamicVars" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="AxisLocalPlus 0 CGT_LOCAL_X CGT_LOCAL_Y CGT_LOCAL_Z"/>
        </Macro>
        <Macro Name="ActiveSpindleMaxSpeed" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="3500"/>
        </Macro>
      </EventSub>
    </Event>
