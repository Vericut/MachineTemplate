...
MCD_SUB_FILES {
	MCD_FILE_NAME "V:\\vericut_6.2\\DMU-70eVLine (iTNC530)_6\\cycl19_dmu70.sub"
}
...
SUPERGROUP "Registers" {
	...
	WORD_VALUE "B" {
		...
		COND_VAR_AND "CGT_ADJ_PLANE_FLAG" "1"
		COND_VAR_AND "5006_1" ">360" {
			MACRO "ErrorMacro" {
				TEXT_OVERRIDE_VALUE "Угол C = {#5006} в CYCL DEF 19.1 превышает пределы поворота (от-360 до 360) !"
			}
		}
		COND_VAR_AND "CGT_ADJ_PLANE_FLAG" "1" {
			MACRO "BAxisMotion"
	...
	WORD_VALUE "C" {
		...
		COND_AND "DEF" "19.1" {
			...
			MACRO "RotationPlaneAngle3" {
				OVERRIDE_EXP "$+38.621"TEXT_OVERRIDE_VALUE "Z"
			}
...
MACRO_MODALS {
	...
	NAME "mmB_AXIS_ROTARY_TYPE" VALUE "mmLINEAR"
	NAME "mmC_AXIS_ROTARY_TYPE" VALUE "mmLINEAR"
