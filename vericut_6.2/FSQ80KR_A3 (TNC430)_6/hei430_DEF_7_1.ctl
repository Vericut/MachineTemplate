...
MCD_SUB_FILES {
	MCD_FILE_NAME "V:\\vericut_6.2\\FSQ80KR_A2 (TNC430)_6\\hei530.sub"
}
...
SUPERGROUP "Registers" {
	...
	WORD_VALUE "CP" {
		...
		COND_VAR_AND "110" ">5400" {
			MACRO "ErrorMacro" {
				TEXT_OVERRIDE_VALUE "Полный угол спирали IPA = {#100} выходит за пределы значений (от -5400 до 5400)!!!"
			}
		}
		COND_AND "DR-"
		COND_VAR_AND "100" ">0" {
