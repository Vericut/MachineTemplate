...
<VcControl Version="7.0" Unit="millimeter">
  ...
  <Words>
    ...
    <Word Name="(" Type="conditional">
      ...
      <Function Name="OliCondLeftParent"/>
    </Word>
    <Word Name="(UAO,0)" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/>
    </Word>
    <Word Name="(UAO,1)" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/>
    </Word>
    <Word Name=")" Type="conditional">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/>
      <Function Name="OliCondRightParent"/>
    </Word>
    ...
    <Word Name="UAO" Type="typeII_cmd">
      <TypeIICommand Syntax="V" />
    </Word>
  ...
  <SuperGroup Name="Specials">
    ...
    <Group Name="(UAO,0)" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Variable Name="5000" Scan="no" AfterMotion="no">
  ...
  <SuperGroup Name="Registers">
    ...
    <Group Name="X" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondVariable Logical="and" Name="5000" Range="1"/>
        <Macro Name="XAxisMachineMotion" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
    ...
    <Group Name="Z" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondVariable Logical="and" Name="(UAO" Range="0"/>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="(UAO,1)" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Macro Name="WorkCoord" Scan="no" AfterMotion="no">
        </Macro>
        <Variable Name="5000" Scan="no" AfterMotion="no">
    ...
    <Group Name="G" Type="word" Description="" Range="79" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
