...
<VcControl Version="7.0" Unit="millimeter">
  ...
  <Words>
    ...
    <Word Name="[" Type="console_message">
    </Word>
    ...
    <Word Name="ACC_EFF" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="" MetricType="decimal" MetricFormat="" Multiply="off" Multiplier="1"/>
    </Word>
    ...
    <Word Name="BSR" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="5.3" MetricType="decimal" MetricFormat="5.3" Multiply="off" Multiplier="1"/>
    </Word>
    ...
    <Word Name="LA OFF" Type="skip">
    </Word>
    <Word Name="LA ON" Type="skip">
    </Word>
    <Word Name="LA_OFF" Type="skip">
    </Word>
    <Word Name="LA_ON" Type="skip">
    </Word>
    ...
    <Word Name="PROGRAMMENDE" Type="skip">
    </Word>
  ...
  <SuperGroup Name="Specials">
    ...
    <Group Name="BSR" Type="word" Description="" Field="0">
      <ConditionMacro>
    ...
    <Group Name="EFF" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="ACC_EFF" Type="word" Description="" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <SuperGroup Name="States">
    ...
    <Group Name="G" Type="word" Description="" Range="6 7 8 9" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="G" Type="word" Description="" Range="70" Field="0">
      <ConditionMacro>
        <Macro Name="UnitsInch" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="G" Type="word" Description="" Range="71" Field="0">
      <ConditionMacro>
        <Macro Name="UnitsMetric" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="G" Type="word" Description="" Range="61 62" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <SuperGroup Name="Cycles">
    ...
    <Group Name="G" Type="word" Description="" Range="83 73" Field="0">
      <ConditionMacro>
        <Macro Name="CyclesDeep" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="G" Type="word" Description="" Range="84 74" Field="0">
      <ConditionMacro>
    ...
    <Group Name="G" Type="word" Description="" Range="86 76" Field="0">
      <ConditionMacro>
        <Macro Name="CyclesBore" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <SuperGroup Name="Registers">
    <Group Name="A" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="65"/>
    ...
    <Group Name="P" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="10,54.1"/>
    ...
    <Group Name="X" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="72"/>
  ...
  <SuperGroup Name="M_Misc">
    ...
    <Group Name="M" Type="word" Description="" Range="10" Field="0">
      <ConditionMacro>
        <Macro Name="ClampCompName" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="M" Type="word" Description="" Range="11" Field="0">
      <ConditionMacro>
        <Macro Name="ClampOnOff" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="M" Type="word" Description="" Range="40 41 42 43 44 45" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="G" Type="word" Description="" Range="44" Field="0">
      <ConditionMacro>
        <Macro Name="ToolLengthCompNeg" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="G" Type="word" Description="" Range="54-59" Field="0">
      <ConditionMacro>
  ...
  <Events>
    <Event Type="conversion_init">
      ...
      <Macro Name="ActiveSpindleMaxSpeed" Scan="no" AfterMotion="no">
        <Override  Type="value"  Value="8000"/>
      </Macro>
    </Event>
