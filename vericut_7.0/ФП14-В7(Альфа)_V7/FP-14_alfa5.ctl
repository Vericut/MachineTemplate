...
<VcControl Version="7.0" Unit="millimeter">
  ...
  <SuperGroup Name="Registers">
    ...
    <Group Name="Z" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="G" Range="49"/>
  ...
  <SuperGroup Name="M_Misc">
    ...
    <Group Name="M" Type="word" Description="" Range="40" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="yes">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="M" Type="word" Description="" Range="42" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <Events>
    <Event Type="conversion_init">
      ...
      <Macro Name="Cinci_5axisToolLengthComp" Scan="no" AfterMotion="no">
        <Override  Type="value"  Value="1"/>
      </Macro>
      <Macro Name="Unitize3DVector" Scan="no" AfterMotion="no">
        <Override  Type="value"  Value="0"/>
      </Macro>
    </Event>
    ...
    <Event Type="block_init">
      ...
      <Macro Name="CinciBlockInit" Scan="no" AfterMotion="no">
      </Macro>
    </Event>
  ...
  <MacroModals>
    ...
    <MacroModal Name="mmTOLERANCE_VALUE"  Value="0.016"/>
