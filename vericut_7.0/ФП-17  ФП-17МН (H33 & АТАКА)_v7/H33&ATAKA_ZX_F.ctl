...
<VcControl Version="7.0" Unit="millimeter">
  <MacroFile>V:\vericut_7.0\ФП-17  ФП-17МН (H33 &amp; АТАКА)_v7\function_33.cme</MacroFile>
  ...
  <Words>
    ...
    <Word Name=":" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="4.0" MetricType="decimal" MetricFormat="4" Multiply="off" Multiplier="1"/>
    </Word>
    ...
    <Word Name="I" Type="macro_call">
      <Value Type="numeric" InchType="decimal" InchFormat="3.4" MetricType="trailing" MetricFormat="6.2" Multiply="off" Multiplier="1"/>
    </Word>
    ...
    <Word Name="TOOL:" Type="begin_comment">
    </Word>
  ...
  <SuperGroup Name="States">
    ...
    <Group Name="G" Type="word" Description="" Range="2" Field="0">
      <ConditionMacro>
        <CondVariable Logical="and" Name="4002" Range="18"/>
        <Macro Name="MotionCCW" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondVariable Logical="and" Name="4002" Range="17"/>
        <Macro Name="MotionCW" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondVariable Logical="and" Name="4002" Range="19"/>
        <Macro Name="MotionCW" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
    ...
    <Group Name="7001 7002 7003" Type="variable" Description="" Field="0">
      <ConditionMacro>
  ...
  <SuperGroup Name="Registers">
    ...
    <Group Name="F" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Macro Name="cms_FeedH33" Scan="yes" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="S" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Macro Name="cms_SpindleSpeedH33" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    ...
    <Group Name="X" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Macro Name="XAxisMotion" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7001"/>
        </Macro>
        <Variable Name="7001" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7001"/>
        </Variable>
      </ConditionMacro>
    </Group>
    <Group Name="Y" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Macro Name="YAxisMotion" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7002"/>
        </Macro>
        <Variable Name="7002" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7002"/>
        </Variable>
      </ConditionMacro>
    </Group>
    <Group Name="Z" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <Macro Name="ZAxisMotion" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7003"/>
        </Macro>
        <Variable Name="7003" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="$+#7003"/>
        </Variable>
      </ConditionMacro>
    </Group>
  ...
  <SuperGroup Name="M_Misc">
    ...
    <Group Name="M" Type="word" Description="" Range="40-46" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <Events>
    ...
    <Event Type="conversion_finish">
      ...
      <Macro Name="ToolLengthCompUpdate" Scan="no" AfterMotion="no">
      </Macro>
    </Event>
