...
<VcControl Version="7.0" Unit="millimeter">
  ...
  <Words>
    ...
    <Word Name="CABEZAL" Type="macro_call">
      <Value Type="none"/>
    </Word>
    ...
    <Word Name="CYCLE" Type="macro_call">
      <Value Type="none"/>
    </Word>
    ...
    <Word Name="HEAD" Type="macro_call">
      <Value Type="none"/>
    </Word>
    ...
    <Word Name="PIEZA" Type="macro_call">
      <Value Type="none"/>
    </Word>
    ...
    <Word Name="ROTAR" Type="macro_call">
      <Value Type="none"/>
    </Word>
  ...
  <NCSubstitutions>
    ...
    <Substitution Input="*  -" Output=";"/>
    <Substitution Input="*   -" Output=";"/>
    <Substitution Input="Q1507" Output="C"/>
    <Substitution Input="Q1506" Output="B"/>
  </NCSubstitutions>
  <OPSubstitutions>
  </OPSubstitutions>
  ...
  <SuperGroup Name="Registers">
    ...
    <Group Name="B" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        <CondWord Logical="and" Name="B" Range="180"/>
      ...
      <ConditionMacro>
        ...
        <CondVariable Logical="and" Name="397" Range="1"/>
        <Macro Name="ErrorMacro" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="B={$}   Пределы перемещения  B  от  0 до 357.5 градусов!!! "/>
        </Macro>
        <Macro Name="CAxisMotion" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#5006"/>
        </Macro>
        <Variable Name="397" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="0"/>
        </Variable>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="B" Range="&gt;357.5"/>
        <CondVariable Logical="and" Name="397" Range="1"/>
        <Macro Name="ErrorMacro" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="B={$}   Пределы перемещения  B  от  0 до 357.5 градусов!!! "/>
        </Macro>
    ...
    <Group Name="C" Type="word" Description="" Field="0">
      ...
      <ConditionMacro>
        ...
        <Macro Name="RotationPlaneAngle1" Scan="no" AfterMotion="no">
          <Override  Type="value"  Value="-45"/>
          <Override  Type="text"  Value="X"/>
        </Macro>
        <Macro Name="RotationPlaneLocal2" Scan="no" AfterMotion="no">
        </Macro>
        <Macro Name="RotationPlaneAngle2" Scan="no" AfterMotion="no">
          <Override  Type="expression"  Value="#5005"/>
          <Override  Type="text"  Value="Z"/>
        </Macro>
        <Macro Name="RotationPlaneLocal2" Scan="no" AfterMotion="no">
        </Macro>
      ...
      <ConditionMacro>
        ...
        <CondVariable Logical="and" Name="397" Range="1"/>
        <Macro Name="ErrorMacro" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="C={$}   Пределы перемещения  C  от  0 до 357.5 градусов!!! "/>
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="C" Range="&gt;357.5"/>
        <CondVariable Logical="and" Name="397" Range="1"/>
        <Macro Name="ErrorMacro" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="C={$}   Пределы перемещения  C  от  0 до 357.5 градусов!!! "/>
        </Macro>
    ...
    <Group Name="CP" Type="word" Description="Circle polar" Field="0">
      <ConditionMacro>
        ...
        <Macro Name="ErrorMacro" Scan="no" AfterMotion="no">
          <Override  Type="text"  Value="Полный угол спирали IPA = {#100} выходит за пределы значений (от -5400 до 5400)!!!"/>
        </Macro>
      </ConditionMacro>
      <ConditionMacro>
        <CondWord Logical="and" Name="DR-"/>
  ...
  <SuperGroup Name="M_Misc">
    ...
    <Group Name="M" Type="word" Description="" Range="10" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="M" Type="word" Description="" Range="11" Field="0">
      <ConditionMacro>
        <Macro Name="IgnoreMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    ...
    <Group Name="M" Type="word" Description="Reduce display of rotary axis to value under 360" Range="94" Field="0">
      <ConditionMacro>
        <Macro Name="RotaryLinearRewind" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
  ...
  <SuperGroup Name="G_Prep">
    ...
    <Group Name="DEF" Type="word" Description="" Range="389" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
    </Group>
    <Group Name="DEF" Type="word" Description="" Range="397" Field="0">
      <ConditionMacro>
        <Macro Name="NullMacro" Scan="no" AfterMotion="no">
        </Macro>
      </ConditionMacro>
  ...
  <Events>
    <Event Type="conversion_init">
      ...
      <Macro Name="TurnOnOffCompTravelLimits" Scan="no" AfterMotion="no">
        <Override  Type="value"  Value="0"/>
        <Override  Type="text"  Value="C"/>
      </Macro>
      <Macro Name="TurnOnOffCompTravelLimits" Scan="no" AfterMotion="no">
        <Override  Type="value"  Value="0"/>
        <Override  Type="text"  Value="B"/>
      </Macro>
  ...
  <MacroModals>
    ...
    <MacroModal Name="mmB_AXIS_ROTARY_TYPE"  Value="mmABSOLUTE_360"/>
